...
export type GetSnippetQuery = { __typename?: 'Query', getSnippet?: { __typename?: 'Snippet', id: string, name: string, code: string, language: Language, slug: string, executions?: Array<{ __typename?: 'Execution', id: string, status: ExecutionStatus, result: string, executedAt: any }> | null } | null };

export type GetAllSnippetsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllSnippetsQuery = { __typename?: 'Query', getAllSnippets: Array<{ __typename?: 'Snippet', id: string, name: string, slug: string }> };
...
export type UpdateSnippetMutation = { __typename?: 'Mutation', updateSnippet: { __typename?: 'Snippet', id: string, slug: string } };
...
export const DeletUserDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"deletUser"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"deleteUserId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteUser"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"deleteUserId"}}}]}]}}]} as unknown as DocumentNode<DeletUserMutation, DeletUserMutationVariables>;
